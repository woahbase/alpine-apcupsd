...
OTHERFLAGS := \
	...
	-c 256 \
	-m 256m \
	# -e APCUPSD__UPSNAME=ups0 \
	# -e APCUPSD__UPSCABLE=usb \
	# -e APCUPSD__UPSTYPE=usb \
	# -e APCUPSD__DEVICE="/dev/usb/hiddev0" \
	# -e APCUPSD_CONFDIR=/srv/apcupsd \
	# -e APCUPSD_MONITOR_HOSTS="ups0.local:UPS 0,,,ups1.local:Non-existent UPS1,test.local:Test UPS,127.0.0.1:Local Host,test.local:Test UPS 2" \
	# -e APCUPSD_HEADLESS=true \
	# -e TZ=Asia/Kolkata \
